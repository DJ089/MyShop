...
public class InfoActivity extends AppCompatActivity {
    ...
    int no =0 ;
    int imgs[]={R.drawable.image1,R.drawable.info2,R.drawable.info3,R.drawable.info4,R.drawable.info5};

    String txts[]={"1번 글미 설명","2번 그림 설명","3번 그림 설명","4번 그림 설명","5번 그림 설명"};
    ImageView img_info;
    TextView txt_info;
    @Override
