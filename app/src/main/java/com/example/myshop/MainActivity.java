        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (strId.length() < 5 || strPw.length() < 8) {
                    Toast.makeText(MainActivity.this, "아이디는 5자 비번은 8자 이상입니다.", Toast.LENGTH_SHORT).show();
                } else {
                    //아이디는 학번, 비번은 "12345678" 이면 정상
                    if (strId.equals("30501") && strPw.equals("12345678")) {
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            ...
            case R.id.btn_guide:
                ...
                Toast.makeText(this, "운영시간", Toast.LENGTH_SHORT).show();
                break;
            case R.id.btn_call:
                intent=new Intent(MainActivity.this,CallActivity.class);
                Toast.makeText(this, "고객센터 화면 이동", Toast.LENGTH_SHORT).show();
                break;
        }
